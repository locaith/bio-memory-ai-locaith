...
| **Replay intent closure (RC-0)** | **VERIFIED** — quyết định lúc ghi là BẰNG CHỨNG BỀN, không phải một hàng vắng mặt: event non-substantive commit kèm một hàng terminal `SKIPPED` **trong cùng transaction** (atomicity kiểm ở cấp process), và quyết định ấy còn nằm trong payload dưới checksum nên sống sót cả khi hàng terminal biến mất. `replay --repair` không dựng nổi marker; mất hàng skip thì được khôi phục **thành quyết định**, không thành ký ức; version rebuild không làm quyết định hết hạn; ý định không xác định thì **báo cáo, không đoán**. Năm mutant R1–R5 đều chết. |
