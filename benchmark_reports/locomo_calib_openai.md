...
- **mem0_profile**: cloud
- **started_at**: 2026-08-12 23:56:35
...
|---|---|---|---|---|---|---|
| naive-rag | 7 | 0.44 | 0.1429 | — | 25.8 | 11.5 |
| bio-memory | 7 | 0.4228 | 0.0 | — | 273.93 | 20.03 |
| mem0 | 7 | 0.3622 | 0.1429 | — | 233.12 | 15.75 |
...
| Category | Count | F1 | EM | Abstention |
|---|---|---|---|---|
| temporal | 7 | 0.4228 | 0.0 | — |

### mem0 — per category

| Category | Count | F1 | EM | Abstention |
|---|---|---|---|---|
| temporal | 7 | 0.3622 | 0.1429 | — |
